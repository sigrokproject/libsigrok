...
static struct sr_dev_driver uni_t_ut8802e_driver_info;
...
static int dev_acquisition_start(const struct sr_dev_inst *sdi)
{
    ...
    serial_source_add(sdi->session, serial, G_IO_IN, 10,
            ut8802e_handle_events, (void *)sdi);
...
static int dev_acquisition_stop(struct sr_dev_inst *sdi)
{
    ...
    /* Initiate stop here. Activity happens in ut8802e_handle_events(). */
    return SR_OK;
}

static struct sr_dev_driver uni_t_ut8802e_driver_info = {
    .name = "uni-t-ut8802e",
    .longname = "UNI-T UT8802E",
    .api_version = 1,
    .init = std_init,
    .cleanup = std_cleanup,
    .scan = scan,
...
SR_REGISTER_DEV_DRIVER(uni_t_ut8802e_driver_info);
