...
#define LOG_PREFIX "wch"

#define WCH_LOGICV8 		48
#define WCH_LOGICV8L		30
#define WCH_LOGICV16		1000
#define WCH_LOGICV16L		600
...
#define WCH_REQUIRED_VERSION_MAJOR	1

#define MAX_8BIT_SAMPLE_RATE	SR_MHZ(24)
#define MAX_16BIT_SAMPLE_RATE	SR_MHZ(500)
...
struct dev_context {
	const struct wch_profile *profile;
